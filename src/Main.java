...
public class Main {
    ...
    static void addDiscountedExpense(){
        ...
        if(!DiscountedExpenses.isEmpty()){
            for (int i = 0; i<DiscountedExpenses.size();i++){
                if (TempObj.getFinalAmount()<=DiscountedExpenses.get(i).getFinalAmount()){DiscountedExpenses.add(i,TempObj); return;}
            }
        }
    ...
    static String showHighestExpense(){
        ...
        else if(DiscountedExpenses.isEmpty()){
        ...
        else if (Expenses.getLast().getAmount()>DiscountedExpenses.getLast().getFinalAmount()) {
            return Expenses.getLast().display();
        }
        else if(Expenses.getLast().getAmount()<DiscountedExpenses.getLast().getFinalAmount()){
            return DiscountedExpenses.getLast().display();
